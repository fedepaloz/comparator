...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Assuming you've already sanitized your input data
    // You should sanitize your data properly to prevent SQL injection

    // Inserting data into the database
    try {
        // Insert the data into your database
        $stmt = $pdo->prepare("INSERT INTO comparator_data (name, lastname, email, phone_number, compilation_date, tax_code, energy_bill_cadence, energy_first_month_consumption, energy_second_month_consumption, energy_client_type, energy_committed_power, energy_available_power, energy_annual_consumption_on_bill, energy_first_year_on_bill, energy_second_year_on_bill, energy_first_month_on_bill, energy_second_month_on_bill, energy_vat_on_bill, energy_interested, gas_interested, energy_expense, energy_management_cost, energy_system_charges, energy_other_costs, energy_excise, energy_vat, energy_rai_fee, gas_first_month_consumption, gas_second_month_consumption, gas_client_type, gas_annual_consumption_on_bill, gas_first_year_on_bill, gas_second_year_on_bill, gas_first_month_on_bill, gas_second_month_on_bill, gas_vat_on_bill, gas_expense, gas_management_cost, gas_system_charges, gas_other_costs, gas_excise, gas_vat) 
        VALUES (:name, :lastname, :email, :phone_number, :compilation_date, :tax_code, :energy_bill_cadence, :energy_first_month_consumption, :energy_second_month_consumption, :energy_client_type, :energy_committed_power, :energy_available_power, :energy_annual_consumption_on_bill, :energy_first_year_on_bill, :energy_second_year_on_bill, :energy_first_month_on_bill, :energy_second_month_on_bill, :energy_vat_on_bill, :energy_interested, :gas_interested, :energy_expense, :energy_management_cost, :energy_system_charges, :energy_other_costs, :energy_excise, :energy_vat, :energy_rai_fee, :gas_first_month_consumption, :gas_second_month_consumption, :gas_client_type, :gas_annual_consumption_on_bill, :gas_first_year_on_bill, :gas_second_year_on_bill, :gas_first_month_on_bill, :gas_second_month_on_bill, :gas_vat_on_bill, :gas_expense, :gas_management_cost, :gas_system_charges, :gas_other_costs, :gas_excise, :gas_vat)");
